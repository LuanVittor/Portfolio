...
export default function ContactPT() {
  return (
    <div className='mainDiv'>
      ...
      <a className='icons' href="portfolio/src/Documents/CurriculoPt-br.pdf" download><img src="https://pixsector.com/cache/5d353540/av3544fca9fdc10112f68.png" alt="Download" height='75' width='75' /></a>
      </div>
      <div className='icons'>
